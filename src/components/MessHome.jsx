            ...
            <div className="modal-body">
              ...
              <div className="selection-options" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div className="toggle-row" style={{ padding: '4px 0' }}>
                  ...
                  <div className={`toggle-switch ${modalMeals.breakfast ? 'active' : ''}`} onClick={() => setModalMeals(prev => ({ ...prev, breakfast: !prev.breakfast }))}>
                ...
                <div className="toggle-row" style={{ padding: '4px 0' }}>
                  ...
                  <div className={`toggle-switch ${modalMeals.lunch ? 'active' : ''}`} onClick={() => setModalMeals(prev => ({ ...prev, lunch: !prev.lunch }))}>
                    <div className="toggle-slider"></div>
                  </div>
                </div>
                ...
                <div className="toggle-row" style={{ padding: '4px 0' }}>
                  ...
                  <div className={`toggle-switch ${modalMeals.dinner ? 'active' : ''}`} onClick={() => setModalMeals(prev => ({ ...prev, dinner: !prev.dinner }))}>
                    <div className="toggle-slider"></div>
                  </div>
                </div>

                <div style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
                  <button className="pay-submit-btn" onClick={handleSaveAdvanceSelection} style={{ margin: 0, flex: 1 }}>Save</button>
                  <button className="cancel-btn" onClick={() => setShowModal(null)} style={{ margin: 0, flex: 1 }}>Cancel</button>
                </div>
              </div>
            </div>
          </div>
